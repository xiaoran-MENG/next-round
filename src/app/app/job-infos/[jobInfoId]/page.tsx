        ...
        <div className="container my-4 space-y-4">
            ...
            <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            ...
                            <SuspendedItem
                                item={jobInfo}
                                fallback={null}
                                result={j => j.title && <Badge variant="secondary">
                                    {j.title}
                                </Badge>}
                            />
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 has-hover:*:not-hover:opacity-70">
                    {options.map((option) => (
                        <Link className="hover:scale-[1.01] transition-[transform_opacity]" href={`/app/job-infos/${jobInfoId}/${option.href}`} key={option.href}>
